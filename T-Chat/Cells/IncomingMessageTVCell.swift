...
class IncomingMessageTVCell: UITableViewCell {
    ...
    fileprivate func setupUICell() {
        ...
        contentView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: contentView.frame.width / 3).isActive = true
